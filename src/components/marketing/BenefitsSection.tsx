...
const Testimonial: React.FC<TestimonialProps> = ({ quote, author, role, image }) => {
  return (
    <div className="card card-hover flex flex-col h-full p-6">
      <div className="mb-4">
        <svg width="45" height="36" className="text-primary/30 mb-2" viewBox="0 0 45 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12 lg:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Beneficios reales para tu <span className="text-primary">clínica</span>
          </h2>
        ...
        <div className="relative mb-16">
          <div className="max-w-4xl mx-auto">
            <div className="card relative rounded-2xl shadow-xl overflow-hidden p-2 md:p-4">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent z-0 opacity-30"></div>
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 lg:w-32 lg:h-32 bg-primary/10 rounded-full blur-2xl z-0"></div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-10">
          <Link href="/api/auth/register" prefetch={false} className="btn-primary inline-flex items-center px-6 py-3 rounded-xl">
