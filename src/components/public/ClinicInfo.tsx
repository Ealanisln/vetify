      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-semibold mb-6" style={{ color: theme.colors.text }}>
                Datos de Contacto
              </h3>
              <div className="space-y-4">
                {tenant.publicPhone && (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm mb-1" style={{ color: theme.colors.textMuted }}>Teléfono</p>
                      <a
                ...
                {tenant.publicEmail && (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm mb-1" style={{ color: theme.colors.textMuted }}>Email</p>
                      <a
                ...
                {tenant.publicAddress && (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-sm mb-1" style={{ color: theme.colors.textMuted }}>Dirección</p>
                      <p
            ...
            {/* Horarios */}
            <div>
              <h3 className="text-xl font-semibold mb-6 flex items-center" style={{ color: theme.colors.text }}>
              ...
              >
                {publicHours ? (
                  <div className="space-y-3">
                    {publicHours.weekdays && (
                      <div className="flex justify-between items-center">
                        <span className="font-medium" style={{ color: theme.colors.text }}>Lunes - Viernes</span>
                        <span style={{ color: theme.colors.textMuted }}>{publicHours.weekdays}</span>
                      </div>
                    )}
                    {publicHours.saturday && (
                      <div className="flex justify-between items-center">
                        <span className="font-medium" style={{ color: theme.colors.text }}>Sábado</span>
                        <span style={{ color: theme.colors.textMuted }}>{publicHours.saturday}</span>
                      </div>
                    )}
                    {publicHours.sunday && (
                      <div className="flex justify-between items-center">
                        <span className="font-medium" style={{ color: theme.colors.text }}>Domingo</span>
                        <span style={{ color: theme.colors.textMuted }}>{publicHours.sunday}</span>
                      </div>
                    )}
                  </div>
                ) : (
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="font-medium" style={{ color: theme.colors.text }}>Lunes - Viernes</span>
                      <span style={{ color: theme.colors.textMuted }}>9:00 - 18:00</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="font-medium" style={{ color: theme.colors.text }}>Sábado</span>
                      <span style={{ color: theme.colors.textMuted }}>9:00 - 14:00</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="font-medium" style={{ color: theme.colors.text }}>Domingo</span>
                      <span style={{ color: theme.colors.textMuted }}>Cerrado</span>
                    </div>
                  </div>
                )}
              </div>
            ...
            >
              ...
              {tenant.publicPhone && (
                <a href={`tel:${tenant.publicPhone}`}>
                  <Button
                    size="sm"
                    className={`bg-red-600 hover:bg-red-700 text-white ${themeClasses.button}`}
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-xs" style={{ color: theme.colors.textMuted }}>- Cliente satisfecho</p>
                </div>
                <div
                  className={`p-4 ${themeClasses.card}`}
                  style={{
